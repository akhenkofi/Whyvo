...
function WhyvoResetApp() {
 ...
 const countries = [
  { code: 'AF', name: 'Afghanistan', dial: '+93', isoHint: 'AF' },
  { code: 'AL', name: 'Albania', dial: '+355', isoHint: 'AL' },
  { code: 'DZ', name: 'Algeria', dial: '+213', isoHint: 'DZ' },
  { code: 'AR', name: 'Argentina', dial: '+54', isoHint: 'AR' },
  { code: 'AU', name: 'Australia', dial: '+61', isoHint: 'AU' },
  { code: 'AT', name: 'Austria', dial: '+43', isoHint: 'AT' },
  { code: 'BD', name: 'Bangladesh', dial: '+880', isoHint: 'BD' },
  { code: 'BE', name: 'Belgium', dial: '+32', isoHint: 'BE' },
  { code: 'BJ', name: 'Benin', dial: '+229', isoHint: 'BJ' },
  { code: 'BF', name: 'Burkina Faso', dial: '+226', isoHint: 'BF' },
  { code: 'BI', name: 'Burundi', dial: '+257', isoHint: 'BI' },
  { code: 'CM', name: 'Cameroon', dial: '+237', isoHint: 'CM' },
  { code: 'CA', name: 'Canada', dial: '+1', isoHint: 'CA' },
  { code: 'CF', name: 'Central African Republic', dial: '+236', isoHint: 'CF' },
  { code: 'TD', name: 'Chad', dial: '+235', isoHint: 'TD' },
  { code: 'CN', name: 'China', dial: '+86', isoHint: 'CN' },
  { code: 'CO', name: 'Colombia', dial: '+57', isoHint: 'CO' },
  { code: 'CD', name: 'Congo (DRC)', dial: '+243', isoHint: 'CD' },
  { code: 'CG', name: 'Congo (Republic)', dial: '+242', isoHint: 'CG' },
  { code: 'CI', name: 'Côte d’Ivoire', dial: '+225', isoHint: 'CI' },
  { code: 'DK', name: 'Denmark', dial: '+45', isoHint: 'DK' },
  { code: 'EG', name: 'Egypt', dial: '+20', isoHint: 'EG' },
  { code: 'ET', name: 'Ethiopia', dial: '+251', isoHint: 'ET' },
  { code: 'FI', name: 'Finland', dial: '+358', isoHint: 'FI' },
  { code: 'FR', name: 'France', dial: '+33', isoHint: 'FR' },
  { code: 'DE', name: 'Germany', dial: '+49', isoHint: 'DE' },
  { code: 'GH', name: 'Ghana', dial: '+233', isoHint: 'GH' },
  { code: 'GR', name: 'Greece', dial: '+30', isoHint: 'GR' },
  { code: 'GN', name: 'Guinea', dial: '+224', isoHint: 'GN' },
  { code: 'HK', name: 'Hong Kong', dial: '+852', isoHint: 'HK' },
  { code: 'IN', name: 'India', dial: '+91', isoHint: 'IN' },
  { code: 'ID', name: 'Indonesia', dial: '+62', isoHint: 'ID' },
  { code: 'IE', name: 'Ireland', dial: '+353', isoHint: 'IE' },
  { code: 'IL', name: 'Israel', dial: '+972', isoHint: 'IL' },
  { code: 'IT', name: 'Italy', dial: '+39', isoHint: 'IT' },
  { code: 'JP', name: 'Japan', dial: '+81', isoHint: 'JP' },
  { code: 'KE', name: 'Kenya', dial: '+254', isoHint: 'KE' },
  { code: 'LR', name: 'Liberia', dial: '+231', isoHint: 'LR' },
  { code: 'MG', name: 'Madagascar', dial: '+261', isoHint: 'MG' },
  { code: 'MW', name: 'Malawi', dial: '+265', isoHint: 'MW' },
  { code: 'MY', name: 'Malaysia', dial: '+60', isoHint: 'MY' },
  { code: 'ML', name: 'Mali', dial: '+223', isoHint: 'ML' },
  { code: 'MR', name: 'Mauritania', dial: '+222', isoHint: 'MR' },
  { code: 'MU', name: 'Mauritius', dial: '+230', isoHint: 'MU' },
  { code: 'MX', name: 'Mexico', dial: '+52', isoHint: 'MX' },
  { code: 'MA', name: 'Morocco', dial: '+212', isoHint: 'MA' },
  { code: 'MZ', name: 'Mozambique', dial: '+258', isoHint: 'MZ' },
  { code: 'NA', name: 'Namibia', dial: '+264', isoHint: 'NA' },
  { code: 'NL', name: 'Netherlands', dial: '+31', isoHint: 'NL' },
  { code: 'NZ', name: 'New Zealand', dial: '+64', isoHint: 'NZ' },
  { code: 'NE', name: 'Niger', dial: '+227', isoHint: 'NE' },
  { code: 'NG', name: 'Nigeria', dial: '+234', isoHint: 'NG' },
  { code: 'NO', name: 'Norway', dial: '+47', isoHint: 'NO' },
  { code: 'PK', name: 'Pakistan', dial: '+92', isoHint: 'PK' },
  { code: 'PH', name: 'Philippines', dial: '+63', isoHint: 'PH' },
  { code: 'PL', name: 'Poland', dial: '+48', isoHint: 'PL' },
  { code: 'PT', name: 'Portugal', dial: '+351', isoHint: 'PT' },
  { code: 'QA', name: 'Qatar', dial: '+974', isoHint: 'QA' },
  { code: 'RW', name: 'Rwanda', dial: '+250', isoHint: 'RW' },
  { code: 'SA', name: 'Saudi Arabia', dial: '+966', isoHint: 'SA' },
  { code: 'SN', name: 'Senegal', dial: '+221', isoHint: 'SN' },
  { code: 'SL', name: 'Sierra Leone', dial: '+232', isoHint: 'SL' },
  { code: 'SG', name: 'Singapore', dial: '+65', isoHint: 'SG' },
  { code: 'ZA', name: 'South Africa', dial: '+27', isoHint: 'ZA' },
  { code: 'KR', name: 'South Korea', dial: '+82', isoHint: 'KR' },
  { code: 'ES', name: 'Spain', dial: '+34', isoHint: 'ES' },
  { code: 'LK', name: 'Sri Lanka', dial: '+94', isoHint: 'LK' },
  { code: 'SE', name: 'Sweden', dial: '+46', isoHint: 'SE' },
  { code: 'CH', name: 'Switzerland', dial: '+41', isoHint: 'CH' },
  { code: 'TZ', name: 'Tanzania', dial: '+255', isoHint: 'TZ' },
  { code: 'TG', name: 'Togo', dial: '+228', isoHint: 'TG' },
  { code: 'TN', name: 'Tunisia', dial: '+216', isoHint: 'TN' },
  { code: 'TR', name: 'Turkey', dial: '+90', isoHint: 'TR' },
  { code: 'UG', name: 'Uganda', dial: '+256', isoHint: 'UG' },
  { code: 'AE', name: 'United Arab Emirates', dial: '+971', isoHint: 'AE' },
  { code: 'GB', name: 'United Kingdom', dial: '+44', isoHint: 'GB' },
  { code: 'US', name: 'United States', dial: '+1', isoHint: 'US' },
  { code: 'ZM', name: 'Zambia', dial: '+260', isoHint: 'ZM' },
  { code: 'ZW', name: 'Zimbabwe', dial: '+263', isoHint: 'ZW' },
 ]
